...
const baseMsgDatabaseWriteResponse: object = {};

export const MsgDatabaseWriteResponse = {
  encode(
    _: MsgDatabaseWriteResponse,
  ...
  fromJSON(_: any): MsgDatabaseWriteResponse {
    const message = {
      ...baseMsgDatabaseWriteResponse,
    } as MsgDatabaseWriteResponse;
    return message;
  ...
  toJSON(_: MsgDatabaseWriteResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial(
    _: DeepPartial<MsgDatabaseWriteResponse>
  ): MsgDatabaseWriteResponse {
    const message = {
      ...baseMsgDatabaseWriteResponse,
    } as MsgDatabaseWriteResponse;
