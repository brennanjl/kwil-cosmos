...
export interface KwilDatabases {
  index?: string;
  dbid?: string;
  owner?: string;
}
...
export type KwilMsgDDLResponse = object;
 ...
 */
export type KwilParams = object;

export interface KwilQueryAllDatabasesResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryDatabasesAll
   * @summary Queries a list of Databases items.
   * @request GET:/kwil/kwil/databases
   */
  queryDatabasesAll = (
    query?: {
    ...
    this.request<KwilQueryAllDatabasesResponse, RpcStatus>({
      path: `/kwil/kwil/databases`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryDatabases
   * @summary Queries a Databases by index.
   * @request GET:/kwil/kwil/databases/{index}
   */
