...
import (
	...
	"kwil/docs"
	kwilmodule "kwil/x/kwil"
	kwilmodulekeeper "kwil/x/kwil/keeper"
	kwilmoduletypes "kwil/x/kwil/types"
...
var (
	...
	maccPerms = map[string][]string{
		...
		kwilmoduletypes.ModuleName:     {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
type App struct {
	*baseapp.BaseApp
	...
	KwilKeeper kwilmodulekeeper.Keeper
...
func New(
	...
	app.KwilKeeper = *kwilmodulekeeper.NewKeeper(
		appCodec,
		keys[kwilmoduletypes.StoreKey],
		keys[kwilmoduletypes.MemStoreKey],
		app.GetSubspace(kwilmoduletypes.ModuleName),
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(kwilmoduletypes.ModuleName)
